...
TextStyle standardTextStyle (double double, FontWeight fontWeight) {
  return TextStyle(fontSize: SizeConfig.screenHeight * double, fontWeight: fontWeight);
}
...
LinearGradient flashyRedGradient = const LinearGradient(
  colors: [
    Color.fromARGB(255, 150, 20, 11),
    Color.fromARGB(255, 135, 19, 11),
    Color.fromARGB(255, 198, 55, 45)
  ],
  stops: [0.001, 0.2, 09],
  begin: Alignment.topLeft,
  end: Alignment.bottomRight,
...
AssetImage ecoviaIconWithText =
    const AssetImage('assets/ecovia_images/ecovia_logo_with_text.png');
AssetImage ecoviaIcon =
    const AssetImage('assets/ecovia_images/ecovia_logo.png');
