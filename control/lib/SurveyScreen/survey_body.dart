...
import 'package:ecovia_control/SurveyScreen/completion_screen.dart';
import 'package:ecovia_control/SurveyScreen/consent_screen.dart';
import 'package:ecovia_control/SurveyScreen/finish_screen.dart';
...
import 'package:ecovia_control/showcase_labels_list.dart';
                        ...
                        itemBuilder: (context, index) {
                            ...
                            return FoodQuestionCard(
                              ...
                              userCallback: (int? val) {
                                setValue(
                                    ...
                                    0.5,
                                    val!,
                                    dietQuestions[index - 1].portionConversion,
                                ...
                                _pageController.nextPage(
                                    duration: const Duration(milliseconds: 500),
                                    curve: Curves.linear);
                                pageIndex.value = _pageController.page!.toInt();
                              },
                          ...
                          if (index == 0) {
                            return ConsentScreen(
                                ...
                                consentText:
                                    'Im Ernährungsprotokoll wird Ihr Ernährungsverhalten der letzten 24 Stunden anhand eines 5- bis 10-minütigen Fragebogens erhoben. Mit der Teilnahme stimmen Sie der Verarbeitung ihrer angebenen Daten gemäß der ECOVIA Datenschutzerklärung zu.\n\nAntworten aus dem Ernährungsprotokoll werden von uns zu Forschungszwecken anonymisiert weiterverarbeitet. Mit der Teilnahme stimmen Sie der Verarbeitung ihrer angebenen Daten gemäß der ECOVIA Datenschutzerklärung zu.\n\nDie Teilnahme ist freiwillig und Sie können die Teilnahme jederzeit bsedingungslos beenden. \n\nSie haben Fragen? Schreiben Sie uns: \nmail@ecovia.app');
                          }
                                ...
                                return FinishScreen(
                                    nextPage: () async {
                                      ...
                                      double totalCO2 = surveyAnswersPre[0]
                                          ...
                                          surveyAnswersPre[0].animalCheeseCO2! +
                                          surveyAnswersPre[0].butterCO2! +
                                          surveyAnswersPre[0].animalJogurtCO2! +
                                          surveyAnswersPre[0].animalMilkCO2! +
                                          surveyAnswersPre[0].animalCreamCO2! +
                                          ...
                                          surveyAnswersPre[0]
                                              .meatSubstitutesCO2! +
                                          surveyAnswersPre[0].plantCheeseCO2! +
                                          surveyAnswersPre[0].plantCreamCO2! +
                                          surveyAnswersPre[0].plantDeliCO2! +
                                          surveyAnswersPre[0].plantJogurtCO2! +
                                          ...
                                          surveyAnswersPre[0].saltySnacksCO2! +
                                      ...
                                      await userCollection
                                        ...
                                        'animalCheeseKG':
                                            surveyAnswersPre[0].animalCheeseKG,
                                        'animalCheeseCO2':
                                            surveyAnswersPre[0].animalCheeseCO2,
                                        'animalCream':
                                        ...
                                        'animalJogurtKG':
                                            surveyAnswersPre[0].animalJogurtKG,
                                        'animalJogurtCO2':
                                            surveyAnswersPre[0].animalJogurtCO2,
                                        'animalMilk':
                                        ...
                                        'beefCO2': surveyAnswersPre[0].beefCO2,
                                        'bread': surveyAnswersPre[0].bread,
                                        'breadKG': surveyAnswersPre[0].breadKG,
                                        'breadCO2':
                                            surveyAnswersPre[0].breadCO2,
                                        ...
                                        'eggsCO2': surveyAnswersPre[0].eggsCO2,
                                        'fish': surveyAnswersPre[0].fish,
                                        'fishKG': surveyAnswersPre[0].fishKG,
                                        'fishCO2': surveyAnswersPre[0].fishCO2,
                                        'freeDrinks':
                                        ...
                                        'fruitsCO2':
                                            surveyAnswersPre[0].fruitsCO2,
                                        'legumes': surveyAnswersPre[0].legumes,
                                        'legumesKG':
                                        ...
                                        'margarineCO2':
                                            surveyAnswersPre[0].margarineCO2,
                                        'meatSubstitutes':
                                            surveyAnswersPre[0].meatSubstitutes,
                                        'meatSubstitutesKG': surveyAnswersPre[0]
                                            .meatSubstitutesKG,
                                        'meatSubstitutesCO2':
                                            surveyAnswersPre[0]
                                                .meatSubstitutesCO2,
                                        ...
                                        'nutsCO2': surveyAnswersPre[0].nutsCO2,
                                        'pasta': surveyAnswersPre[0].pasta,
                                        'pastaKG': surveyAnswersPre[0].pastaKG,
                                        'pastaCO2':
                                            surveyAnswersPre[0].pastaCO2,
                                        'plantCheese':
                                        ...
                                        'plantMilkCO2':
                                            surveyAnswersPre[0].plantMilkCO2,
                                        'poultry': surveyAnswersPre[0].poultry,
                                        'poultryKG':
                                        ...
                                        'porkCO2': surveyAnswersPre[0].porkCO2,
                                        'potatoes':
                                        ...
                                        'riceCO2': surveyAnswersPre[0].riceCO2,
                                        'saltySnacks':
                                        ...
                                        'tofuCO2': surveyAnswersPre[0].tofuCO2,
                                        'vegetables':
